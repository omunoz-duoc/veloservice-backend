...
public record OrdenDetalleResult(
    ...
    List<OrdenEstadoResult> historialEstados
) {
    public OrdenDetalleResult(
            ...
            String bicicletaColor, String bicicletaNumeroSerie, String bicicletaAro,
            ...
            UUID mecanicoId, String mecanicoNombre, String mecanicoApellido,
            String prioridad, List<ComentarioResult> comentarios, List<MultimediaResult> multimedia,
            List<OrdenProductoResult> productos, List<OrdenServicioResult> servicios
    ) {
        this(id, numeroOrden, tallerId, sucursalId, estadoId, estadoCodigo, estadoNombre,
                ...
                bicicletaMarca, bicicletaModelo, bicicletaTipo, bicicletaColor,
                bicicletaNumeroSerie, bicicletaAro, bicicletaAnio, bicicletaFotoUrl,
                bicicletaNotas, clienteId, clienteNombre, clienteApellido, clienteTelefono,
                clienteEmail, clienteRut, null, mecanicoId, mecanicoNombre, mecanicoApellido,
                prioridad, null, null, comentarios, multimedia, productos, servicios, List.of());
    }
}
