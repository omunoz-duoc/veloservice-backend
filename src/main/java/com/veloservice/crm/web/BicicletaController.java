package com.veloservice.crm.web;

import com.veloservice.crm.api.BicicletaRequest;
import com.veloservice.crm.api.BicicletaResponse;
import com.veloservice.crm.internal.service.BicicletaService;
...
public class BicicletaController {
    ...
    public ResponseEntity<BicicletaResponse> crear(
        ...
        return ResponseEntity.ok(bicicletaService.crear(clienteId, request));
    }
    ...
    public ResponseEntity<List<BicicletaResponse>> listarPorCliente(@PathVariable UUID clienteId) {
        return ResponseEntity.ok(bicicletaService.listarPorCliente(clienteId));
    }
